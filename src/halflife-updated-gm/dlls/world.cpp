...
{
	// Sound precaches are level resources. Never carry the deduplication cache
	// into the next map, where the engine has a new resource table.
	ResetPrecacheSoundCache();
